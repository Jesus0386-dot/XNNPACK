...
TEST(QU8_RSUM__SCALAR_U4, overflow_accumulator) {
  ...
  TEST(QU8_RSUM__SSE41_U16, batch_eq_16) {
    TEST_REQUIRES_X86_SSE41;
    RSumMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qu8_rsum_ukernel__sse41_u16);
  }

  TEST(QU8_RSUM__SSE41_U16, batch_div_16) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U16, batch_lt_16) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U16, batch_gt_16) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 17; batch_size < 32; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U16, scale) {
    TEST_REQUIRES_X86_SSE41;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(17)
  ...
  TEST(QU8_RSUM__SSE41_U16, overflow_accumulator) {
    TEST_REQUIRES_X86_SSE41;
    RSumMicrokernelTester()
      .batch_size(2048)
      .Test(xnn_qu8_rsum_ukernel__sse41_u16);
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(QU8_RSUM__SSE41_U32, batch_eq_32) {
    TEST_REQUIRES_X86_SSE41;
    RSumMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qu8_rsum_ukernel__sse41_u32);
  }

  TEST(QU8_RSUM__SSE41_U32, batch_div_32) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 64; batch_size < 320; batch_size += 32) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U32, batch_lt_32) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 1; batch_size < 32; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U32, batch_gt_32) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 33; batch_size < 64; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U32, scale) {
    TEST_REQUIRES_X86_SSE41;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(33)
  ...
  TEST(QU8_RSUM__SSE41_U32, overflow_accumulator) {
    TEST_REQUIRES_X86_SSE41;
    RSumMicrokernelTester()
      .batch_size(4096)
      .Test(xnn_qu8_rsum_ukernel__sse41_u32);
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(QU8_RSUM__SSE41_U64, batch_eq_64) {
    TEST_REQUIRES_X86_SSE41;
    RSumMicrokernelTester()
      .batch_size(64)
      .Test(xnn_qu8_rsum_ukernel__sse41_u64);
  }

  TEST(QU8_RSUM__SSE41_U64, batch_div_64) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U64, batch_lt_64) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U64, batch_gt_64) {
    TEST_REQUIRES_X86_SSE41;
    for (size_t batch_size = 65; batch_size < 128; batch_size++) {
      RSumMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_RSUM__SSE41_U64, scale) {
    TEST_REQUIRES_X86_SSE41;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(65)
  ...
  TEST(QU8_RSUM__SSE41_U64, overflow_accumulator) {
    TEST_REQUIRES_X86_SSE41;
    RSumMicrokernelTester()
      .batch_size(8192)
      .Test(xnn_qu8_rsum_ukernel__sse41_u64);
