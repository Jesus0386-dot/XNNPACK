...
BENCHMARK_CAPTURE(qu8_rsum, scalar_u4,
  ...
  BENCHMARK_CAPTURE(qu8_rsum, sse41_u16,
                    xnn_qu8_rsum_ukernel__sse41_u16,
                    /*init_params=*/nullptr,
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  BENCHMARK_CAPTURE(qu8_rsum, sse41_u32,
                    xnn_qu8_rsum_ukernel__sse41_u32,
                    /*init_params=*/nullptr,
                    benchmark::utils::CheckSSE41)
    ->Apply(BenchmarkRSUM)
    ->UseRealTime();
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  BENCHMARK_CAPTURE(qu8_rsum, sse41_u64,
                    xnn_qu8_rsum_ukernel__sse41_u64,
                    /*init_params=*/nullptr,
                    benchmark::utils::CheckSSE41)
    ->Apply(BenchmarkRSUM)
    ->UseRealTime();
